...
// app.get(locations[0].next
// 	res.send(routes.locations[0].title);
// 	})

// app.get('/', routes.index);
// app.get(locations[0].next, function(req,res) {
// 	console.log(locations)
// 	res.send(locations[0].title);
// 	})



app.get('/getlocation', routes.getlocation);
